...
def get_district_data(tiff_filename:str, value_name:str, data):
    ...
    gdf = gpd.read_file('./geoshp/gadm36_CHE_3.shp')
...
def get_district_data1(tiff_filename:str, value_name:str, data):
    tiff_dataset = rasterio.open(tiff_filename)
    gdf = gpd.read_file('./geoshp/gadm36_CHE_1.shp')
...
def save_annual_tiff_land():
    ...
    save_tiff('./tif_file/annual1/BuiltUp.tif', BuiltUp, lon_grid, lat_grid)
    save_tiff('./tif_file/annual1/Bare.tif', Bare, lon_grid, lat_grid)
    save_tiff('./tif_file/annual1/Tree.tif', Tree, lon_grid, lat_grid)
    save_tiff('./tif_file/annual1/Crops.tif', Crops, lon_grid, lat_grid)
    save_tiff('./tif_file/annual1/Grass.tif', Grass, lon_grid, lat_grid)
    save_tiff('./tif_file/annual1/Shrub.tif', Shrub, lon_grid, lat_grid)
    save_tiff('./tif_file/annual1/MossLichen.tif', MossLichen, lon_grid, lat_grid)
    save_tiff('./tif_file/annual1/Snow.tif', Snow, lon_grid, lat_grid)
    save_tiff('./tif_file/annual1/PermanentWater.tif', PermanentWater, lon_grid, lat_grid)
    save_tiff('./tif_file/annual1/SeasonalWater.tif', SeasonalWater, lon_grid, lat_grid)

    weighted_pm25, weighted_pm25_district = get_district_data('./tif_file/annual1/pm25_2020.tif', 'pm25_2020', pm252020_data)
    weighted_pm10, weighted_pm10_district = get_district_data('./tif_file/annual1/pm10_2020.tif', 'pm10_2020', pm102020_data)

    # weighted_daily_pm25, weighted_daily_pm25_district = get_district_data('./tif_file/annual1/aqg_pm25.tif', 'day_pm25', aqg_pm25)
    # weighted_daily_pm10, weighted_daily_pm10_district = get_district_data('./tif_file/annual1/aqg_pm10.tif', 'day_pm10', aqg_pm10)

    weighted_pop_bt, weighted_pop_bt_district = get_district_data('./tif_file/annual1/pop_bt.tif', 'pop_bt', pop_bt)
    weighted_pop_mt, weighted_pop_mt_district = get_district_data('./tif_file/annual1/pop_mt.tif', 'pop_mt', pop_mt)
    weighted_pop_ft, weighted_pop_ft_district = get_district_data('./tif_file/annual1/pop_ft.tif', 'pop_ft', pop_ft)
    weighted_pop_bt_0_14, weighted_pop_bt_0_14_district = get_district_data('./tif_file/annual1/pop_bt_0_14.tif', 'pop_bt_0_14', pop_bt_0_14)
    weighted_pop_bt_15_64, weighted_pop_bt_15_64_district = get_district_data('./tif_file/annual/pop_bt_15_64.tif', 'pop_bt_15_64', pop_bt_15_64)
    weighted_pop_bt_65, weighted_pop_bt_65_district = get_district_data('./tif_file/annual/pop_bt_65.tif', 'pop_bt_65', pop_bt_65)
    ...
    weighted_BuiltUp, _ = get_district_data('./tif_file/annual1/BuiltUp.tif', 'BuiltUp', BuiltUp)
    weighted_Bare, _ = get_district_data('./tif_file/annual1/Bare.tif', 'Bare', Bare)
    weighted_Tree, _ = get_district_data('./tif_file/annual1/Tree.tif', 'Tree', Tree)
    weighted_Crops, _ = get_district_data('./tif_file/annual1/Crops.tif', 'Crops', Crops)
    weighted_Grass, _ = get_district_data('./tif_file/annual1/Grass.tif', 'Grass', Grass)
    weighted_Shrub, _ = get_district_data('./tif_file/annual1/Shrub.tif', 'Shrub', Shrub)
    weighted_MossLichen, _ = get_district_data('./tif_file/annual1/MossLichen.tif', 'MossLichen', MossLichen)
    weighted_Snow, _ = get_district_data('./tif_file/annual1/Snow.tif', 'Snow', Snow)
    weighted_PermanentWater, _ = get_district_data('./tif_file/annual1/PermanentWater.tif', 'PermanentWater', PermanentWater)
    weighted_SeasonalWater, _ = get_district_data('./tif_file/annual1/SeasonalWater.tif', 'SeasonalWater', SeasonalWater)
